								...
								<div class="container_12" style="height:60px;">
									<div class="grid_12">
										...
										?>
											...
											<li class="item-1"><a href="tour-dates.php">Evento</a></li>											<!-- <li class="last"><a href="contacts.php">Contacts</a></li> -->
										</ul>
										<div class="clear"></div>
									</div>
									<div class="clear"></div>
...
<!--==============================content================================-->
			...
			<script>
				function menu(caso)
				{
					switch(caso)
					{
						case 1:document.location.replace("gallery.php?codigo=1");break;
						case 2:document.location.replace("gallery.php?codigo=2");break;
						case 3:document.location.replace("gallery.php?codigo=3");break;
						case 4:document.location.replace("gallery.php?codigo=4");break;
						case 5:document.location.replace("gallery.php?codigo=5");break;
