...
?>
	...
	?>
	<script type="text/javascript">
		alert("Por favor Logueate para poder continuar :) Bienvenido a Polleria Paredes");
					...
					<div class="bg-1">
						...
						?>
							<div width=30% height=100% style="float: left; background: transparent; ">
								<tr>
									<td bgcolor=#000 style='color:#fff'>
										<div class="bienvenida">
											<h2>Welcome !!! Enjoy this website !!!</h2>
										</div>
										<div class="center">
											<?php
								...
								<tr>
									<td valign=top width=20% bgcolor=white></td>
								</tr>
							</div>
						<?php
						} else {
			...
			<div class="main">
				<div class="content-padding-2">
					<div class="container_12">
						<div class="wrapper">
							<center>
										<h2>Aqui visualizaras nuestros proximos eventos</h2>
										<iframe src="https://calendar.google.com/calendar/embed?src=dhdk9vqh2spd3h4b0akuhfr258%40group.calendar.google.com&ctz=America%2FLima" style="border: 0" width="800" height="600" frameborder="0" scrolling="no"></iframe>
							</center>
